...
public final class Mirror {
  ...
  public static Field getField(final Class<?> clazz, final String name) throws ReflectiveOperationException {
    try {
  ...
  public static Field getField(final Object obj, final String name) throws ReflectiveOperationException {
  ...
  public static <T> T getFieldValue(final Object obj, final String name) throws ReflectiveOperationException {
    return getFieldValue(obj.getClass(), obj, name);
  }

  public static <T> T getFieldValue(final Class<?> clazz, final String name) throws ReflectiveOperationException {
    return getFieldValue(clazz, null, name);
  }

  public static void setFieldValue(final Class<?> clazz, final Object obj, final String name, final Object value)
      throws ReflectiveOperationException {
  ...
  public static boolean hasMethod(final Class<?> clazz, final String name, final Class<?> ...params) {
    try {
  ...
  public static boolean hasMethod(final Object obj, final String name, final Class<?> ...params) {
    return hasMethod(obj.getClass(), name, params);
  }

  public static boolean hasConstructor(final Class<?> clazz, final Class<?> ...params) {
    try {
  ...
  public static Class<?> wrapPrimitiveValue(final Class<?> clazz) {
    return PRIMITIVES.getOrDefault(clazz, clazz);
  }

  public static Class<?>[] getTypes(final Object ...params) {
